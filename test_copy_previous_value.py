...
class DoRun(ScriptDefinition):
    def run(self, field1=CopyPreviousRow("1"), field3="3"):
        pass

    def parameters_valid(self, field1=CopyPreviousRow("1"), field3="3"):
        reason = ""
        if field1 != "1":
    ...
    def estimate_time(self, field1=CopyPreviousRow("1"), field3="2"):
