...
class TestEmuRun(unittest.TestCase):
    ...
    def test_GIVE_temp_BUT_no_field_WHEN_run_THEN_temp_set_BUT_not_field_AND_run_happens(self, cget_mock):
    ...
    @patch.dict("sys.modules", inst=inst)
    @patch('genie_python.genie.cget', return_value={"value": "A Magnet"})
    def test_GIVE_field_BUT_no_temp_WHEN_run_THEN_field_set_BUT_not_temp_AND_run_happens(self, cget_mock):
