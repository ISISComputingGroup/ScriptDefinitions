...
non_zero_field_with_active_zf_error_message = "Cannot set a non-zero field with the active zero field\n"
...
class TestParameterValidation(unittest.TestCase):
    ...
    @parameterized.expand([
        (
            {
                ...
                "start_field": "keep", "stop_field": "keep", "step_field": "1",
        ...
        (
            {
                "start_temperature": "keep", "stop_temperature": "1.0", "step_temperature": "1",
                "start_field": "keep", "stop_field": "keep", "step_field": "1",
                "custom": "None", "mevents": "10", "magnet_device": "TF"
            },
        ...
        (
            {
                "start_temperature": "1.0", "stop_temperature": "keep", "step_temperature": "1",
                "start_field": "keep", "stop_field": "keep", "step_field": "1",
                "custom": "None", "mevents": "10", "magnet_device": "TF"
            },
            start_stop_must_both_be_keep_error_message.format("temperature")
        ...
        (
            {
                "start_temperature": "keep", "stop_temperature": "keep", "step_temperature": "1",
                "start_field": "keep", "stop_field": "1.0", "step_field": "1",
                "custom": "None", "mevents": "10", "magnet_device": "TF"
            },
        ...
        (
            {
                "start_temperature": "keep", "stop_temperature": "keep", "step_temperature": "1",
                "start_field": "1.0", "stop_field": "keep", "step_field": "1",
                "custom": "None", "mevents": "10", "magnet_device": "TF"
            },
            start_stop_must_both_be_keep_error_message.format("field")
        ),
        (
            {
                "start_temperature": "10.5", "stop_temperature": "1.0", "step_temperature": "0",
                "start_field": "1", "stop_field": "30.0", "step_field": "0",
                "custom": "None", "mevents": "10", "magnet_device": "TF"
            },
            step_is_zero_error_message
        ),
        (
            {
                "start_temperature": "10.5", "stop_temperature": "1.0", "step_temperature": "-0.0001",
                "start_field": "2", "stop_field": "30.0", "step_field": "-2",
                "custom": "None", "mevents": "10", "magnet_device": "TF"
            },
            step_is_not_positive_error_message
        ),
        (
            {
                "start_temperature": "10.5", "stop_temperature": "1.0", "step_temperature": "1",
                "start_field": "1", "stop_field": "20.2", "step_field": "2",
                "custom": "None", "mevents": "10", "magnet_device": "ZF"
            },
        ...
        (
            {
                "start_temperature": "10.5", "stop_temperature": "1.0", "step_temperature": "1",
                "start_field": "1", "stop_field": "1", "step_field": "2",
                "custom": "None", "mevents": "10", "magnet_device": "ZF"
            },
            non_zero_field_with_active_zf_error_message
        ),
        (
            {
                "start_temperature": "10.5", "stop_temperature": "1.0", "step_temperature": "1",
                "start_field": "1", "stop_field": "1", "step_field": "2",
                "custom": "None", "mevents": "10", "magnet_device": "INVALID"
            },
        ...
        (
            {
                "start_temperature": "10.5", "stop_temperature": "1.0", "step_temperature": "1",
                "start_field": "1", "stop_field": "10.0", "step_field": "2",
                "custom": "None", "mevents": "10", "magnet_device": "N/A"
            },
            field_set_but_magnet_device_not_selected_error_message
        )
    ...
    def test_GIVEN_params_WHEN_validate_THEN_appropriate_return(self, params, expected_return):
        self.assertEqual(
            self.script_definition.parameters_valid(**params),
            expected_return
        )
